// REST API for the control room. Response shapes mirror the old Convex
// dashboard queries so the ported React UI needs no rework.
...
// ---------------------------------------------------------------------------
// Dashboard reads (ported from convex dashboard.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Control mutations (ported from convex dashboard.ts)
// ---------------------------------------------------------------------------
